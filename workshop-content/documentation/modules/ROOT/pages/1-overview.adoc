...
The goal of this lab is to assess the benefits of using containers by providing a hands-on experience in building a container image and using podman to create and run containers. This lab also aims to showcase the integration of CI/CD processes to automate certain tasks.  
