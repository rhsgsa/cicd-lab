...
. Below shows the screen for `get-a-user-login` landing page
+
image::get-user-login-information.png[Get User Login Information]
...
+
image::initial-workshop-landing-page.png[Initial WorkShop Landing Page]

On this page, you will have access to your username, password, lab instructions, OpenShift console, Gitea and Quay.

Important
You have to use an unique username (e.g. %USER%) while you’re running the hands-on labs. For example, you need to deploy applications to your own project (e.g. %USER%).
