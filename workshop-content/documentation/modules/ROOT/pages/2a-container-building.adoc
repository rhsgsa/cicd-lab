...
. On your DevSpaces console, elect the "Go" template to start your workspace on Dev Spaces console
+
...
. Clone the "sample-app" repo from your Gitea console onto your Dev Spaces terminal. 
