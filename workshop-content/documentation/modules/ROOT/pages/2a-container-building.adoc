...
. Login to the {DEVSPACES_URL}#{GIT_URL}/%USER%/devfile [OpenShift Dev Spaces Console,window=console] in a new browser tab - and enter your assigned username and password
+
...
+
 $ podman login \
     registry-quay-quay-enterprise.apps.cluster-ck6cg.sandbox2981.opentlc.com \
     --username %USER% \
     --password redhat
...
+
 $ podman tag \
     ...
     registry-quay-quay-enterprise.apps.cluster-ck6cg.sandbo2981.opentlc.com/%USER%/podman-simpleweb:v1

. Push the Container Image into your Quay Registry
+
 $ podman push registry-quay-quay-enterprise.apps.cluster-ck6cg.sandbox2981.opentlc.com/%USER%/podman-simpleweb:v1
...
+
 $ podman pull registry-quay-quay-enterprise.apps.cluster-ck6cg.sandbox2981.opentlc.com/%USER%/podman-simpleweb:v1
...
+
 $ podman run -d -p 8080:8080 --name podman-simpleweb 
   registry-quay-quay-enterprise.apps.cluster-ck6cg.sandbox2981.opentlc.com/user1/podman-simpleweb:v1
