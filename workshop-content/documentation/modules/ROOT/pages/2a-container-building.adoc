= 2. Container Building on MicroShift
...
== 2.1 Building Your First Container Image 
...
== 2.2 Pushing the Container Image Into Your Quay Registry
...
== 2.3 Accessing Your MicroShift Instance
...
== 2.4 Pulling the Container Image from your Quay Registry
...
== 2.5 Building the container using the podman-simpleweb image
