...
+
 $ podman tag \
     ...
     registry-quay-quay-enterprise.apps.cluster-xxxx.sandboyyyy.opentlc.com/%USER%/podman-simpleweb:v1

. Push the Container Image into your Quay Registry
+
 $ podman push registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/%USER%/podman-simpleweb:v1
...
+
 $ podman pull registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/%USER%/podman-simpleweb:v1
...
+
   REPOSITORY                                                                                       TAG         IMAGE ID      CREATED         SIZE
   registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/user1/podman-simpleweb  v1          27970bae2dae  10 minutes ago  222 MB
...
+
 $ podman run -d -p 8080:8080 --name podman-simpleweb 
   registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/user1/podman-simpleweb:v1
