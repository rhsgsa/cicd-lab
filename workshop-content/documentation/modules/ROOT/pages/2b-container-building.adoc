...
+
 $ podman login \
     registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com \
     --username %USER% \
     --password redhat
...
+
 $ podman tag \
     ...
     registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/%USER%/podman-simpleweb:v2

. Push the Container Image into your Quay Registry
+
 $ podman push registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/%USER%/podman-simpleweb:v2
...
+
 $ podman pull registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/%USER%/podman-simpleweb:v2
...
+
   REPOSITORY                                                                                       TAG         IMAGE ID      CREATED         SIZE
   registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/user1/podman-simpleweb  v2          27970bae2dae  17 minutes ago  222 MB
   registry-quay-quay-enterprise.apps.cluster-xxxxp.sandboxyyyy.opentlc.com/user1/podman-simpleweb  v1          27970bae2dae  17 minutes ago  222 MB
...
+
 $ podman run -d -p 8080:8080 --name podman-simpleweb 
   registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/%USER%/podman-simpleweb:v1
...
+
  ...
  29bc1542e8e2  registry-quay-quay-enterprise.apps.cluster-xxxx.sandboxyyyy.opentlc.com/user1/podman-simpleweb:v1              14 seconds ago  Up 2 seconds              podman-simpleweb
