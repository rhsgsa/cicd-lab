...
You have successfully compiled and re-built your application with the reflected change in source code. You are now done with the first half of the hands-on workshop!
